...
// De route linkt nu naar /farm_map en gebruikt de 'map' functie. We maken het ID optioneel.
Route::get('/farm_map/{id?}', [FarmingController::class, 'map'])->name('farmers.map');
